...
function renderizarVistaBienvenida() { 
    ...
    // LA LLAMADA A asignarEventListenersGlobales() SE QUITA DE AQUÍ. Se llamará desde main.js -> appInit()
    cambiarVista(null, 'vista-bienvenida'); 
}

function renderizarListaDashboard(divId, libros, tipoLista) { /* ... (código igual que la última versión refactorizada) ... */ }
function renderizarDashboard() { /* ... (código igual, llama a funciones globales como cargarMisLibrosEnPrestamo y asignarEventListenersLibros) ... */ }
